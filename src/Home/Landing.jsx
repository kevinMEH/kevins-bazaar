    ...
    return (
        <div className="md:flex md:flex-row-reverse md:gap-8 md:items-center">
            ...
            <div className="mt-9 md:mt-0 space-y-4 text-center md:text-left">
                <h1 className="font-serif text-darkGray text-4xl md:text-[2.75rem] lg:text-6xl font-bold">
                    Making dream homes dreamier.
                </h1>
                <p className="text-medGray text-lg lg:text-xl">At Kevin's Bazaar, we provide our customers with premium, custom made furnishing for their homes.</p>
